...
{
    public class ServiceRatingService : BaseCRUDService<ServiceRating, ServiceRatingViewModel, ServiceRatingInsertModel, ServiceRatingUpdateModel>, IServiceRatingService
    {
